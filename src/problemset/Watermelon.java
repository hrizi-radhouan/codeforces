 ...
 * positive weight.
 * 
 * Input The first (and the only) input line contains integer number w (1 ≤ w ≤
 * 100) — the weight of the watermelon bought by the boys.
 * 
 * Output Print YES, if the boys can divide the watermelon into two parts, each
...
public class Watermelon {
	...
	public static void main(String[] args) {
		...
		int w = in.nextInt();
		String output = (w > 2) ? (w % 2 == 0) ? "YES" : "NO" : "NO";
